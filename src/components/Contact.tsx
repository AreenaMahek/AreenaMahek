...
export default function Contact() {
  return (
    <section id="contact" className="py-20 md:py-32 bg-[var(--card-bg)]/30">
      <div className="section-container">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <a
              href="mailto:areenamahek1998@gmail.com"
              className="flex items-center gap-2 px-6 py-3 bg-[var(--primary)] hover:bg-[var(--primary-light)] text-white rounded-lg transition-all duration-300 font-medium"
            >
              <svg
                className="w-5 h-5"
                fill="none"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a
              href="https://linkedin.com/in/areena-mahek/"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center p-6 bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl hover:border-[var(--primary)]/50 transition-colors duration-300"
            >
              <div className="p-4 bg-[var(--primary)]/10 rounded-full mb-4 group-hover:bg-[var(--primary)]/20 transition-colors">
                <svg
              ...
              <p className="text-sm text-[var(--text-muted)]">areena-mahek</p>
            </a>

            <a
              href="https://github.com/AreenaMahek"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center p-6 bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl hover:border-[var(--primary)]/50 transition-colors duration-300"
            >
            ...
            <div className="group flex flex-col items-center p-6 bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl hover:border-[var(--primary)]/50 transition-colors duration-300">
              ...
              <p className="text-sm text-[var(--text-muted)]">Chicago, IL</p>
            </div>
          </div>
        </div>
      </div>
